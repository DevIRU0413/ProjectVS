...
{// 플레이어가 선택 가능한 클레스
    ...
    {// 클레스별 초기 스탯을 설정해 놓은 보관함
        ...
        {
            {CharacterClass.Axe, new PlayerStats(20,30,10,3,0.5f) }, // 도끼 클레스는 튼튼하고 강하지만 느림
            {CharacterClass.Sword, new PlayerStats(25,20,8,6,2) },// 검 클레스는 안정적이고 빠름
            {CharacterClass.Magic, new PlayerStats(15,25,5,4,1) } // 마법 클레스는 공격 사거리가 길지만 약함
        };
    }
