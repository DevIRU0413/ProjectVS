...
using CsvReaderClass = ProjectVS.Utils.CsvReader.CsvReader;


namespace ProjectVS.Utils.Csv
{
    /// <summary>
    /// # Summary
    ...
    public class Csv
    {
        ...
        public string FilePath => Path.Combine(CsvReaderClass.BasePath, _filePath);
