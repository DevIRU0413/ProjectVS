...
namespace ProjectVS.UIs.PanelBehaviours.CharacterSelectionPanelButtons
{
    public class CharacterSelectionPanelButtons : MonoBehaviour
    {
        ...
        public void OnClickSelectButton()
        {
            ...
            {
                case 1:
                    PlayerDataManager.Instance.TestCharacterClass = CharacterClass.Sword;
                    PlayerDataManager.ForceInstance.SavePlayerData(_controlFilePanel.CurrentFileIndex);
                    break;
                case 2:
                    PlayerDataManager.Instance.TestCharacterClass = CharacterClass.Axe;
                    PlayerDataManager.ForceInstance.SavePlayerData(_controlFilePanel.CurrentFileIndex);
                    break;
                case 3:
                    PlayerDataManager.Instance.TestCharacterClass = CharacterClass.Magic;
                    PlayerDataManager.ForceInstance.SavePlayerData(_controlFilePanel.CurrentFileIndex);
                    break;
                default:
